...
#define _SG_LOG_ITEMS \
    ...
    _SG_LOGITEM_XMACRO(VALIDATE_UPDATEBUF_MAP, "sg_update_buffer: cannot call sg_update_buffer and sg_map_buffer in same frame") \
...
_SOKOL_PRIVATE bool _sg_validate_update_buffer(const _sg_buffer_t* buf, const sg_range* data) {
        ...
        _SG_VALIDATE(buf->cmn.map_frame_index != _sg.frame_index, VALIDATE_UPDATEBUF_MAP);
        return _sg_validate_end();
    #endif
}
